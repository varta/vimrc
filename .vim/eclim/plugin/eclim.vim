...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/Applications/Eclipse.app/Contents/MacOS/plugins/org.eclim_1.7.6.22-g1e3be0c'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/Applications/Eclipse.app/Contents/MacOS'
  if has('win32unix')
