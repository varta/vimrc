...
" SeySayux stuff
syn match processingConstant /\<k[A-Z]\w\+/
syn match processingMember /\<m[A-Z]\w\+/
syn match processingGlobal /\<g[A-Z]\w\+/

syn cluster javaTop add=processingConstant
syn cluster javaTop add=processingMember
syn cluster javaTop add=processingGlobal
...
" Extras (SeySayux)
hi def link processingMember Identifier
hi def link processingGlobal WarningMsg 
